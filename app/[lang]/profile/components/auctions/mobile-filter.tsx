...
export const ProfileAuctionsListMobileFilter = (props: {
  opened: boolean
  options: CustomSelectOption[]
  activeFilter: ProfileAuctionsStatus
  handleClose: () => void
  setActiveFilter: (filter: ProfileAuctionsStatus) => void
}) => {
          ...
          <div className="mb-40 h-100">
            ...
            <div className="mt-30 mb-30">
              ...
              <CustomSelect
                ...
                options={options}
                defaultCurrent={
                  activeFilter === ProfileAuctionsStatus.ALL
                    ? 0
                    : activeFilter === ProfileAuctionsStatus.ACTIVE
                      ? 1
                      : 2
                }
                onChange={(newValue) => {
                  setActiveFilter(newValue.id as ProfileAuctionsStatus)
                }}
