...
export const PromotedAuctionsRoot = (props: { auctions: Record<string, unknown>[] }) => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      console.error(`Could not load promoted auctions: ${error}`)
  ...
  return (
    ...
    >
      <div className="d-flex align-items-start justify-content-start section-header">
        <h1 className="m-0">{t('generic.promoted_auctions')}</h1>
      </div>
