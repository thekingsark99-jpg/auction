...
export const ReportAuctionModal = (props: ReportAuctionModalProps) => {
  const globalContext = useGlobalContext()
  const currentLanguage = globalContext.currentLanguage
  const { t } = useTranslation(currentLanguage)

  const { isOpened, isBid = false, close, onConfirm } = props
    ...
    >
      <h4>
        {t('reports.sure_to_report', {
          name: t(isBid ? 'reports.sure_to_report_bid' : 'reports.sure_to_report_auction'),
        })}
      </h4>
